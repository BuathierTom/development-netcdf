...
# Création d'un DataFrame à partir des listes lat, lon et doc
data = pd.DataFrame({"lat": lat, "lon": lon, "doc": doc})


# On créé une grille avec les valeurs de doc en fonction de lat et lon (1626x1626)
...
da = xr.DataArray(doc_grid, dims=["lat", "lon"], coords={"lat": data["lat"], "lon": data["lon"]})
